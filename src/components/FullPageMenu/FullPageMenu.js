...
const FullPageMenu = () => {
  ...
  return (
    ...
    >
      <div className="container relative grid flex-1 grid-rows-menu before:absolute before:block before:bg-cover before:bg-secondary before:bg-menu-pattern-mobile lg:before:bg-menu-pattern before:inset-0 before:h-full before:w-full">
